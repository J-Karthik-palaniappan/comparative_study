...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.,
                 mech = "original", iters=2, num_landmarks=16, ):
        ...
        if self.mech == "original":
            ...
            mechs = {
                "pnp": PnPNystraAttention,
                "nystrom": NystromAttention,
                "performer": PerformerAttention
            }
            attn_cls = mechs[self.mech] # throws error if random model name given
    ...
    def forward(self, x, mask=None):
        ...
        if self.mech == "original":
            ...
            x = self.attention(q*self.scale, k, v, x_shape=(B_, N, C), mask=mask)
